...
<div class="layui-panel" style="margin: 10px 200px">
  <div style="padding: 32px;">
    <%
      int id = Integer.parseInt(request.getParameter("id"));
      SqlSession sqlSession = MyBatisUtil.getSqlSession();
      NewsMapper newsMapper = sqlSession.getMapper(NewsMapper.class);
      News news = newsMapper.queryByNewsId(id);
    %>
    <h2><%=news.getTitle()%></h2>
    <br/>
    <p>发布时间：<%=news.getPublishTime()%><span style="float: right"><a href="<%=news.getUrl()%>">原文链接</a> </span> </p>
    <p>作者：<%=news.getAuthor()%><span style="float: right">关键词：<%=news.getKeyWord()%></span></p>
    <hr/>
